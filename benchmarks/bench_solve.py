...
# Problem definitions live at module scope so callers that import this
# module for its helpers do not pay any benchmark cost on import.
...
def run_benchmark():
    ...
    r.block_until_ready()
    print(
        f"  jit grad (first call, includes trace): "
